...
Placeholder landing — replace via future site plugin.
*/
?>
<!DOCTYPE html>
<html lang="ru">
					...
					<div class="row align-items-center">
						<div class="col-lg-6 d-flex align-items-center">
							<div class="hostin-landing-hero py-5 py-lg-10">
								<span class="hostin-landing-badge">Open Source · FLOWAXY</span>
								<h1 class="font-weight-bolder text-dark display-4 mb-4">HOSTINPL 5.6</h1>
								<p class="text-dark-50 font-size-lg line-height-xl mb-6">
									Панель управления игровым и веб-хостингом: биллинг, серверы, оплата и поддержка в одном месте.
								</p>
								...
								<p class="text-muted font-size-sm mt-2 mb-0">
									Публичный сайт появится здесь позже — сейчас заглушка до подключения плагина.
								</p>
							</div>
						</div>
