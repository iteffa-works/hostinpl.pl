...
- Plugin system: hooks/filters, lifecycle (`install` / `activate` / `disable` / `uninstall`), admin `/admin/plugins`, plugin routes `/admin/plugin/{id}/...`
- Reference plugin `site-landing` (guest landing + settings page)
